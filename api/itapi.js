(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://it.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_AtlP5Q&dl_target_url=https://it.aliexpress.com/item/'+params.id+'.html';
	}
