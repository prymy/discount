(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://de.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_AFIIbq&dl_target_url=https://de.aliexpress.com/item/'+params.id+'.html';
	}
