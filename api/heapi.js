(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://he.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_98xxhI&dl_target_url=https://he.aliexpress.com/item/'+params.id+'.html';
	}
