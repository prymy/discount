(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://es.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_AAjnHQ&dl_target_url=https://es.aliexpress.com/item/'+params.id+'.html';
	}
