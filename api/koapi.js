(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://ko.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_9ioPle&dl_target_url=https://ko.aliexpress.com/item/'+params.id+'.html';
	}
