(function(){
	...
	if(params.id) {
		if(fafifu) location.replace('https://pl.aliexpress.com/item/'+params.id+'.html');
		else location.href = 'http://s.click.aliexpress.com/deep_link.htm?aff_short_key=_Af0bqC&dl_target_url=https://pl.aliexpress.com/item/'+params.id+'.html';
	}
